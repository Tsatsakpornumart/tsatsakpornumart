/**
 * TSATSAKPORNU POS - GLOBAL CONFIGURATION
 * Provide your Supabase Cloud credentials here to automatically connect all devices
 * logging into the system to the same shared backend database.
 */
